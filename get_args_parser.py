...
def get_args_parser(num_classes, vit_type = None, text_prompt = True, box_prompt = None, pretrained_model = None, original_sam = None, start_epoch = None, total_training_epochs = 1000):
